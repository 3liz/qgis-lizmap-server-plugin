...
def test_formfeature_error(client):
    ...
    qs = "?SERVICE=EXPRESSION&REQUEST=Evaluate&MAP=france_parts.qgs&LAYER=france_parts"
    qs += "&FILTER=%s" % (quote("NAME_1 = current_value('prop0')", safe=""))
...
def test_request_get_feature_form_scope_current_value(client):
    ...
    qs = {
        ...
        "MAP": PROJECT_FILE,
        "LAYER": "france_parts",
        "FILTER": quote("NAME_1 = current_value('prop0')", safe=""),
        "FORM_FEATURE": json.dumps(
            {
                "type": "Feature",
...
def test_request_get_feature_form_scope_with_spatial_filter(client):
    ...
    qs = {
        ...
        "MAP": PROJECT_FILE,
        "LAYER": "france_parts",
        "FILTER": quote("intersects($geometry, @current_geometry)", safe=""),
        "FORM_FEATURE": json.dumps(
            {
                "type": "Feature",
...
def test_request_given_parent_feature(client):
    ...
    qs = {
        ...
        "MAP": PROJECT_FILE,
        "LAYER": "france_parts",
        "FILTER": quote("NAME_1 = current_parent_value('prop0')", safe=""),
        "FORM_FEATURE": json.dumps(
            {
                "type": "Feature",
                "geometry": {"type": "Point", "coordinates": [-3.0, 48.0]},
...
def test_request_current_parent_feature(client):
    ...
    qs = {
        ...
        "MAP": PROJECT_FILE,
        "LAYER": "france_parts",
        "FILTER": quote("NAME_1 = attribute(@current_parent_feature, 'prop0')", safe=""),
        "FORM_FEATURE": json.dumps(
            {
                "type": "Feature",
                "geometry": {"type": "Point", "coordinates": [-3.0, 48.0]},
...
def test_request_current_parent_geometry(client):
    ...
    qs = {
        ...
        "MAP": PROJECT_FILE,
        "LAYER": "france_parts",
        "FILTER": quote("intersects($geometry, @current_parent_geometry)", safe=""),
        "FORM_FEATURE": json.dumps(
            {
                "type": "Feature",
                "geometry": {"type": "Point", "coordinates": [102.0, 0.5]},
